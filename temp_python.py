...
filePath = '/home/julian/Documents/jcZoomcamp2024/01-docker-terraform/ny-taxi-data/yellow_tripdata/yellow_tripdata_{}.csv.gz'
...
yearMonths = [year + '-' + str(month).zfill(2) for year in ['2019'] for month in range(10,13)]
